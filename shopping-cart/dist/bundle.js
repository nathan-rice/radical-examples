...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_redux_1 = __webpack_require__(166);
	var api_1 = __webpack_require__(190);
	var components_1 = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Radical = __webpack_require__(191);
	...
	var StoreContainer = (function (_super) {
	    __extends(StoreContainer, _super);
	    function StoreContainer() {
	        _super.apply(this, arguments);
	        this.defaultState = { products: {}, quantities: {} };
	        this.setQuantity = Radical.Action.create({
	            initiator: function (action, product, quantity) {
	                return action.dispatch({ product: product, quantity: quantity });
	            },
	            reducer: function (state, action) {
	                var product = action.product, quantity = action.quantity;
	                if (!state.products[product.id]) {
	                    state.products = Object.assign((_a = {}, _a[product.id] = product, _a), state.products);
	                }
	    ...
	    StoreContainer.prototype.add = function (product, quantity) {
	        if (quantity === void 0) { quantity = 1; }
	        var startingQuantity = this.getQuantity(product);
	        this.setQuantity(product, startingQuantity + quantity);
	        return this;
	    };
	    StoreContainer.prototype.remove = function (product, quantity) {
	        if (quantity === void 0) { quantity = 1; }
	        var startingQuantity = this.getQuantity(product);
	    ...
	    StoreContainer.prototype.list = function () {
	        var state = this.getState(), quantities = state.quantities, products = [];
	    ...
	    StoreContainer.prototype.getQuantity = function (product) {
	...
	var ShoppingCart = (function (_super) {
	    ...
	    function ShoppingCart() {
	        _super.apply(this, arguments);
	        this.checkout = Radical.Action.create({
	    ...
	    ShoppingCart.prototype.getTotal = function () {
	        var _a = this.getState(), quantities = _a.quantities, products = _a.products, total = 0;
	        for (var key in quantities) {
	            if (quantities.hasOwnProperty(key))
	                total += quantities[key] * products[key].price;
	        }
	...
	var Store = (function (_super) {
	    ...
	    function Store() {
	        _super.apply(this, arguments);
	        this.inventory = StoreContainer.create({ name: "Inventory" });
	        this.shoppingCart = ShoppingCart.create();
	    }
	    Store.prototype.order = function (product, quantity) {
	        if (quantity === void 0) { quantity = 1; }
	    ...
	    Store.prototype.cancelOrder = function (product, quantity) {
	        if (quantity === void 0) { quantity = 1; }
	...
	var w = window, devToolExtension = w.devToolsExtension ? w.devToolsExtension() : undefined;
	exports.store = Redux.createStore(function (state) { return state; }, null, devToolExtension);
	exports.webStore = Store.create({ store: exports.store });
	exports.store.replaceReducer(exports.webStore.reduce);
	exports.webStore.inventory
...
/***/ function(module, exports) {
	...
	var ApiComponent = (function () {
	    ...
	    ApiComponent.prototype.configure = function (config) {
	        if (config) {
	            ...
	            if (config.store) {
	                if (!config.getState)
	                    this.getState = config.store.getState;
	                if (!config.dispatch)
	                    this.dispatch = config.store.dispatch;
	            }
	        }
	        return this;
	    };
	...
	var Namespace = (function (_super) {
	    ...
	    function Namespace() {
	        ...
	        this.reduce = function (state, action) {
	            if (!state)
	                return _this.compileDefaultState();
	            else {
	    ...
	    Namespace.prototype.isUnmountedComponent = function (key) {
	        var obj = this[key];
	        return obj instanceof ApiComponent && !this.mountLocation(obj) && key != 'parent';
	    };
	    Namespace.prototype.configure = function (config) {
	        ...
	        var key;
	        for (key in this) {
	            if (this.isUnmountedComponent(key))
	    ...
	    Namespace.prototype.compileDefaultState = function () {
	        for (var location_2 in this.components) {
	            var state = void 0, component = this.components[location_2];
	            if (component instanceof Namespace)
	                state = component.compileDefaultState();
	            else
	                state = component.defaultState;
	            this.updateDefaultState(this._stateLocation[location_2], state);
	        }
	    ...
	    Namespace.prototype.mountLocation = function (component) {
	        for (var location_3 in this.components) {
	            if (component == this.components[location_3])
	                return location_3;
	        }
	        return null;
	    };
	    ...
	    function CollectionNamespace() {
	        ...
	        this.reduce = function (state, action) {
	            if (!state)
	                ...
	                var location_4, stateLocation = void 0, reducer = void 0;
	                for (location_4 in _this.components) {
	                    stateLocation = _this._stateLocation[location_4];
	                    reducer = _this.components[location_4].reduce;
	                    if (stateLocation) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(190);
	var React = __webpack_require__(1);
	var react_redux_1 = __webpack_require__(166);
	exports.App = function (_a) {
	    return (React.createElement("div", null, React.createElement("h2", null, "Shopping Cart Example"), React.createElement("hr", null), React.createElement(Products, {title: "Products"}), React.createElement("hr", null), React.createElement(Cart, null)));
	};
	function productsLink() {
	    return { products: api.webStore.inventory.list() };
	}
	var productsLinkConnect = function (productsClass) { return react_redux_1.connect(productsLink)(productsClass); };
	var Products = (function (_super) {
	    ...
	    Products.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement("h3", null, this.props.title), React.createElement("div", null, this.props.products.map(function (product) {
	...
	var cartLinkConnect = function (cartClass) { return react_redux_1.connect(cartLink)(cartClass); };
	var Cart = (function (_super) {
	    __extends(Cart, _super);
	    function Cart() {
	        _super.apply(this, arguments);
	    }
	    Cart.prototype.getProductNodes = function () {
	        var products = this.props.products;
	        return !products.length ?
	            React.createElement("em", null, "Please add some products to cart.") :
	            products.map(function (product) { return React.createElement(CartItem, {key: product.id, product: product}); });
	    };
	    Cart.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement("h3", null, "Your Cart"), React.createElement("div", null, this.getProductNodes()), React.createElement("p", null, "Total: $", api.webStore.shoppingCart.getTotal()), React.createElement("button", {onClick: api.webStore.shoppingCart.checkout, disabled: this.props.products.length ? '' : 'disabled'}, "Checkout")));
	    };
	    Cart = __decorate([
	        cartLinkConnect
	    ], Cart);
	...
	var CartItem = (function (_super) {
	    ...
	    CartItem.prototype.render = function () {
	        ...
	        return (React.createElement("div", {style: { marginBottom: 20 }}, React.createElement(Product, {title: product.title, price: product.price, quantity: api.webStore.shoppingCart.getQuantity(product), key: product.id}), React.createElement("button", {onClick: function () { return api.webStore.cancelOrder(product); }}, "Remove")));
	    };
	    return CartItem;
	}(React.Component));
	...
	var Product = (function (_super) {
	    ...
	    Product.prototype.render = function () {
	        var _a = this.props, price = _a.price, quantity = _a.quantity, title = _a.title;
	        return React.createElement("span", null, " ", title, " - $", price, " ", quantity ? "x " + quantity : null, " ");
	    };
	    return Product;
	}(React.Component));
	exports.Product = Product;
	var ProductItem = (function (_super) {
	    ...
	    ProductItem.prototype.render = function () {
	        var product = this.props.product;
	        return (React.createElement("div", {style: { marginBottom: 20 }}, React.createElement(Product, {title: product.title, price: product.price}), React.createElement("button", {onClick: function () { return api.webStore.order(product); }}, "Add to cart")));
	    };
	    return ProductItem;
	}(React.Component));
